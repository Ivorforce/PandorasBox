...
public class PBEffects
{
    public static void registerEffectCreators()
    {
        ...
        PBECRegistry.register(new PBECBuffEntities(new ILinear(20 * 3, 20 * 6), new IConstant(1), new DLinear(8.0, 25.0), 0.95f, Arrays.asList(new WeightedPotion(100, MobEffects.SLOWNESS, 4, 8, 20 * 6, 20 * 20))), "frozenInPlace", false);
