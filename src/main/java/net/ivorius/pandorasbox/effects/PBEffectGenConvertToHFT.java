...
import net.ivorius.pandorasbox.worldgen.WorldGenColorfulTree;
import net.ivorius.pandorasbox.worldgen.WorldGenLollipop;
import net.ivorius.pandorasbox.worldgen.WorldGenRainbow;
