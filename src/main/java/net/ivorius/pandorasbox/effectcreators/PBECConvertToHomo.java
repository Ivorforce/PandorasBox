...
import net.ivorius.pandorasbox.effects.PBEffectGenConvertToHomo;
...
public class PBECConvertToHomo implements PBEffectCreator
{
    ...
    public PBEffect constructEffect(World world, double x, double y, double z, Random random)
    {
        ...
        PBEffectGenConvertToHomo effect = new PBEffectGenConvertToHomo(time, range, PandorasBoxHelper.getRandomUnifiedSeed(random));
        return effect;
    }
